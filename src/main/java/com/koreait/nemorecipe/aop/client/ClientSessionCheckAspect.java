...
public class ClientSessionCheckAspect {
	...
	public Object sessionCheck(ProceedingJoinPoint joinPoint) throws Throwable{
		...
		Object result = null;
		if(uri.equals("/client/loginform") || uri.equals("/client/main") || uri.equals("/client/signin") || uri.equals("/client/login") || uri.equals("/client/signup")|| uri.equals("/client/detail")) {
			//검증이 필요 X
